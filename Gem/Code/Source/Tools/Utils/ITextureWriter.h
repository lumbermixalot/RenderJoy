...
namespace RenderJoy
{
    ...
    {
    public:
        ITextureWriter() = delete;
        ITextureWriter(uint16_t mipLevels, AZ::RHI::Format pixelFormat, const AZ::IO::Path& outputDir, const AZStd::string& stemPrefix);
        ...
        //! in this case even if the mip was processed successfully the TextureWriter may not save 
        //! new files to disk.
        ...
        uint32_t GetBytesPerRow(uint16_t mipLevel) const;
